...
public class MainModOptions : OptionInterface {
    ...
    public static Configurable<bool> slug_on_back = main_mod_options.config.Bind("slugOnBack", defaultValue: true, new ConfigurableInfo("When enabled, you can only drop slugcats from your back when holding down/up and grab. Leeches don't target carried slugcats.", null, "", "SlugOnBack"));
